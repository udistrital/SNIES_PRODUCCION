...
$NO ELIMINAR ES UTIL PARA UN PROCESO EN BASH
duplicados = array(53134121);
foreach($duplicados as $duplicado){
    for($ano = 2007;$ano <= 2010;$ano++){
        for($periodo = 1;$periodo <=3;$periodo += 2){
		$valor[0]=$ano;
  ...
  */
		...
		//$cadena_sql.=" AND ROWNUM <=10";
                //$cadena_sql.=" and est_nro_iden= ".$duplicado." ";
                //$cadena_sql.=" and est_nro_iden= 1026275691";
			...
			alerta::sin_registro($configuracion,$cadena);	
                    ...
                    for($contador=$iter_ini;$contador<$iter_fin;$contador++){
                              ...
                              if($valido=='SI'){
                                    ...
                                    echo "<hr>".$contador." - Estudiante : ".$registroPrincipal[0][10]." ".$registroPrincipal[0][3]." => cod: ".$registroPrincipal[0][11]." ";
                                    echo "<br>proyecto : ".$registroPrincipal[0][12]." ";
                                ...
                                if($validoP=='SI'){
                                        ...
                                        if(!is_array($registroParticipanteSnies)){                                                        
                                                            ...
                                                            if(!is_array($registroDatosParticipante))
                                                                     ...
                                                                     echo "<font color='red'><br>***El Estudiante con documento = <span class='texto_negrita'>".$valor[2]."</span> no se puede cargar como Participante, por falta de datos<br></font>";
                                                                   ...
                                                                   // echo $cadena_sql;exit;
                                                                    ...
                                                                    if ($registroDatosParticipante[0][12]!=$registro[$contador][10])
                                                                        ...
                                                                        if($resultadoParticipante==false){
                                                                                ...
                                                                                echo "<font color='red'><br>***El registro Matriculado no pudo ser cargado en la tabla participante por:".$resultadoParticipante."<br></font>";
                                                                            ...
                                                                            echo "<font color='green'><br>El registro fue guardado con Exito, como participante<br></font>";
                                                                            $participante++;
                                                                        }
                                                            }
                                            ...
                                            if(!isset($unError))
                                            {
                                                ...
                                                if(!is_array($registroMatriculado)){
                                                    ...
                                                    if($resultadoMatriculado==false){
                                                        ...
                                                        echo "<font color='red'><br>El registro Del Matriculado no pudo ser cargado por:".$resultadoMatriculado."<br></font>";
                                                        
                                                    }
                                                    else
                                                             {   echo "<font color='green'><br>El registro fue guardado con Exito, como matriculado<br></font>";
                                                                 $matriculado++;
                                                     }
                                                }
                                             else
                                                 {   echo "<font color='blue'><br>El registro ya existe, como matriculado<br></font>";
                                    ...
                                    echo "<font color='red'><br>***El registro del estudiante matriculado contiene datos de la academica vacios que son importante reportar.<br>Revise su fuente de informaci&oacute;n!<br></font>";
                                    $sindatos++;
                                }
                       }//if($valido=='SI'){
                       else{
        ...
        } //else if(!is_array($registro)){
    //} // for($periodo = 1;$periodo <=3;$periodo += 2) proceso en bash
//} // for($ano = 1;$ano <=3;$ano += 2) proceso en bash
//} // Cierra Foreach proceso en bash
...
//	*******************************************************************************************************PARTICIPANTE
		...
		case "participanteAcademica":
			...
			$cadena_sql="SELECT ";
                        ...
                        $cadena_sql.="TO_CHAR(DECODE (mun_cod,0,11001,'',11001,99999,11001, mun_cod)) municipio_ln, ";
                        ...
                        $cadena_sql.="TO_CHAR(DECODE(est_tipo_iden_ant,'',DECODE(length(est_nro_iden_ant),11,'TI',12,'TI','CC'),'C', 'CC', '1', 'CC', 'c', 'CC', 'T', 'TI', '2', 'TI', 't', 'TI', 'E', 'CE', 'P', 'PS', 'CC')) tipo_id_ant, ";
                        $cadena_sql.="est_nro_iden_ant codigo_id_ant, ";
