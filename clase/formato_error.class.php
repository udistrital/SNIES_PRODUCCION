...
*/
/***************************************************************************
* @name          formato_error.class.php 
* @author        Luis Fernando torres
* @revision      Última revisión 17 de julio de 2008
****************************************************************************
* @subpackage   
* @package	clase
* @copyright    
...
* @description  Esta clase esta disennada para darle formato a los mensajes 
...
*@access private
*@param  $cadenaError
*		Cadena de caracteres enviados por la base de datos. 
*@param  $restriccion
*		caracteres que se quieren buscar dentro de cadenaError, ej: restricciones o codigo del error
*@param  $formatoMensaje
*		Mensaje que se quiere mostrar dependiendo del error
*@param  $enlace
...
*TO DO    	Implementar formateo de mensajes de base de datos		
*******************************************************************************/
