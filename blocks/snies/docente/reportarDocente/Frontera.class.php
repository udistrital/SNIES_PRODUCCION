	...
	function html() {
		...
		if (isset ( $_REQUEST ['opcion'] )) {
			...
			switch ($_REQUEST ['opcion']) {
				...
				case "auditoriaDocente" :
					include_once ($this->ruta . "/formulario/auditoriaDocente.php");
					break;
				
				case "reportarDocenteDoctoradoMaestria" :
					include_once ($this->ruta . "/formulario/docenteDoctoradoMaestria.php");
					break;
