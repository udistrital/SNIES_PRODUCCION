...
<br>
<h3>PROFESORES DOCTORADO MAESTRIA- ACTUALIZACIÓN LOCAL</h3>
<br>
<table id="example" class="display" cellspacing="0" width="100%">
	...
	<tbody>
		...
		foreach ( $periodo as $miPeriodo ) {
			...
			$enlaceActualizarProfesorDoctoradoMaestria = $this->enlaceActualizarVariable ( 'actualizarDocenteDoctoradoMaestria', $miPeriodo ['annio'], $miPeriodo ['semestre'] );	
			
			?>
				<tr>
			<td><?php echo 'Docente Doctorado y Maestría';?></td>
			...
			<td align="center"><a class=miEnlace
				href="<?php echo $enlaceActualizarProfesorDoctoradoMaestria;?>"><img
