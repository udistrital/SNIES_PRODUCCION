...
<br>
<h3>ADMITIDO - ACTUALIZACIÓN SNIES CENTRAL</h3>
<br>
<table id="example" class="display" cellspacing="0" width="100%">
	...
	<tbody>
		...
		foreach ( $periodo as $miPeriodo ) {
			$enlaceActualizarAdmitido = $this->enlaceActualizarVariable ( 'actualizarAdmitido', $miPeriodo ['annio'], $miPeriodo ['semestre'] );
			?>
				<tr>
