...
if (class_exists ( 'BloqueloginSso' ) === false) {
	class BloquemenuHorizontal implements Bloque {
		var $nombreBloque;
		var $miFuncion;
		var $miSql;
		var $miConfigurador;
...
if (isset ( $lenguaje )) {
	$esteBloque = new BloquemenuHorizontal ( $unBloque, $lenguaje );
} else {
	$esteBloque = new BloquemenuHorizontal ( $unBloque );
}
